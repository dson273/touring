            ...
            <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
                <div class="w100 fl title-tour1">
                    <h2 style="color: #ffc700;font-size: 30px;"><img
                            ...
                            style="width: 80px;">Danh mục: Tour Giá Sốc</h2>
                </div>
                    ...
                    <div class="col-md-4 col-xs-12 lst-tour-item">
                        <div class="w100 fl bx-wap-pr-item">
                            <div class="clearfix box-wap-imgpr">
                                <a
                                    href="{{route('tour', ['du-lich-noi-dia'])}}">
                                    <img src="{{ asset('frontend/images/logo-ghenh-da-dia.jpg') }}" class="img-default"
                                        alt="tour" style="margin-bottom: 6px;">
                                    <img src="{{ asset('frontend/images/merry-christmas-1.png') }}"
                            ...
                            <div class="clear"></div>
                            <h4><a
                                    href="{{route('tour', ['du-lich-noi-dia'])}}">Tour
                            ...
                            <div class="group-book w100 fl">
                                ...
                                <a href="{{route('tour', ['du-lich-noi-dia'])}}" class="link-book btn_view_tour0">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
